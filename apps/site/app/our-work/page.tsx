...
const ALL_CASES: WorkCase[] = [
  ...
  },
  {
    ...
    featured: false, // not featured → excluded from this page
    summary:
      "ERA supported MKR Fabricators in aligning their emergency response manufacturing capabilities with evolving federal program and procurement needs.",
    imageUrl: "/img/case4.webp",
  },
];

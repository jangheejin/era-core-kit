...
export default function HomePageEditor() {
  ...
  const featuredCount = useMemo(() => {
    ...
    if (typeof candidate === "number" && allowed.has(candidate))
      return candidate;
    return 3;
  ...
  const sectionLabels = useMemo(() => {
    ...
    const extras = content.extraSections.map((block) => {
      const title =
        (block.props as { heading?: string }).heading || (block.type as string);
  ...
  function updateMission<K extends keyof typeof content.mission>(
    ...
    updateSection("mission", { [key]: value } as Partial<
      typeof content.mission
    >);
  }
          ...
          <section className="admin-form-section">
            ...
            <div className="admin-grid-2">
              ...
              <div className="admin-field">
                ...
                <p className="admin-hint">
                  Choose how many featured case studies appear on the homepage.
                  Even counts (4 or 6) use a 2-column layout on mid-size
                  screens.
                </p>
              </div>
            </div>
            ...
            <div className="admin-field">
              ...
              <p className="admin-hint">
                ...
                homepage. Pick up to {featuredCount} from the Featured list
                above.
              </p>
            </div>
            ...
            <div className="admin-field">
              ...
              <div className="dbListGrid">
                {selectedFeaturedItems.length === 0 ? (
                  <p className="muted">
                    No homepage featured items yet. Add up to {featuredCount}{" "}
                    from the Featured list above.
                  </p>
                ) : (
                ...
                return (
                  <div key={key} className="admin-field">
                    ...
                    <textarea
                      ...
                      value={props.body}
                      onChange={(e) =>
                        updateExtraSection(key, { body: e.target.value })
                      }
                    />

...
const site = {
    ...
    description: "ERA Government Affairs is a premier government affairs, consulting and public affairs firm",
...
export default function RootLayout({ children }) {
    return (_jsx("html", { lang: "en", className: `${inter.variable} ${oswald.variable}`, children: _jsx("body", { children: children }) }));
}

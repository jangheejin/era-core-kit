...
import { CaseStudy as CaseStudySchema, } from "./schemas";
import { CaseStudySeedSchema } from "./seeds";
// --------------------
// --------------------
...
const CASE_STUDIES_FIXTURE_FULL_RAW = [
    {
        ...
        summaryShort: "Supporting geospatial modernization and federal engagement for critical mapping and location intelligence.",
        brief: "Partnered with Sanborn and AppGeo to strengthen federal positioning, align capabilities with agency program needs, and support long-term contract and grant opportunities.",
        outcomes: [
            {
                label: "Program positioning",
                description: "Positioned combined capabilities within key federal geospatial programs.",
            },
            {
                label: "Engagement strategy",
                description: "Developed targeted engagement strategy with priority agencies and committees.",
            },
            {
                label: "Preparedness visibility",
                description: "Improved visibility for geospatial contributions to national preparedness.",
            },
        ],
        evidence: [],
        ...
        sections: [
            {
                id: "context",
                title: "Context",
                bodyMDX: "Strengthen federal profile, align capabilities with program needs, and support long-term contract + grant pathways.",
            },
            {
                id: "impact",
                title: "Outcomes",
                bodyMDX: "- Positioned combined capabilities within key federal geospatial programs.\n- Developed targeted engagement strategy with priority agencies and committees.\n- Improved visibility for geospatial contributions to national preparedness.\n",
            },
        ],
        attachments: [],
        links: [],
    ...
    },
    {
        ...
        summaryShort: "Helping a nonprofit translate technical geospatial work into policy-relevant impact stories in DC.",
        brief: "Helped NAPSG translate technical geospatial capabilities into accessible narratives for federal decision-makers, aligned to current priorities and usable in outreach.",
        outcomes: [
            {
                label: "Clearer value proposition",
                description: "Clarified value proposition for non-technical federal audiences.",
            },
            {
                label: "Policy alignment",
                description: "Connected nonprofit initiatives to active federal policy conversations.",
            },
            {
                label: "Stakeholder relationships",
                description: "Supported durable relationships with key emergency management stakeholders.",
            },
        ],
        evidence: [],
        ...
        sections: [
            {
                id: "context",
                title: "Context",
                bodyMDX: "Highly technical work needed a policy-facing narrative that travels well in DC conversations.",
            },
            {
                id: "impact",
                title: "Outcomes",
                bodyMDX: "- Clarified value proposition for non-technical federal audiences.\n- Connected initiatives to active policy conversations.\n- Supported relationships with emergency management stakeholders.\n",
            },
        ],
        attachments: [],
        links: [],
    ...
    },
    {
        ...
        summaryShort: "Guiding a growing government contractor through the realities of federal procurement and engagement.",
        brief: "Advised Crucis on realistic entry points into the federal marketplace: procurement pathways, program alignment, and relationship-building with agencies and Hill staff.",
        outcomes: [
            {
                label: "Entry points mapped",
                description: "Mapped realistic entry points into federal programs and contracts.",
            },
            {
                label: "Targeted outreach plan",
                description: "Developed a targeted plan for outreach and capability briefing.",
            },
            {
                label: "Avoided common pitfalls",
                description: "Helped avoid common missteps that slow or stall federal growth.",
            },
        ],
        evidence: [],
        ...
        sections: [
            {
                id: "context",
                title: "Context",
                bodyMDX: "Growth in federal markets is constrained by procurement rules, timelines, and trust-building—so strategy matters more than hype.",
            },
            {
                id: "impact",
                title: "Outcomes",
                bodyMDX: "- Mapped realistic entry points into federal programs and contracts.\n- Built a plan for outreach and capability briefing.\n- Avoided missteps that slow federal growth.\n",
            },
        ],
        attachments: [],
        links: [],
    ...
    },
    {
        ...
        summaryShort: "Connecting real-world emergency response manufacturing needs with the federal ecosystem.",
        brief: "Aligned emergency response manufacturing capabilities with federal program and procurement realities, focused on practical deployment in disaster-response contexts.",
        outcomes: [
            {
                label: "Program alignment",
                description: "Aligned manufacturing capabilities with specific federal emergency programs.",
            },
            {
                label: "Procurement positioning",
                description: "Clarified how to position products against existing procurement pathways.",
            },
            {
                label: "Sustainable engagement",
                description: "Supported a strategy for sustainable public-sector engagement.",
            },
        ],
        evidence: [],
        ...
        sections: [
            {
                id: "context",
                title: "Context",
                bodyMDX: "Emergency manufacturing value has to map cleanly onto programs + procurement pathways to actually deploy.",
            },
            {
                id: "impact",
                title: "Outcomes",
                bodyMDX: "- Aligned manufacturing capabilities with specific federal emergency programs.\n- Clarified positioning against procurement pathways.\n- Supported sustainable public-sector engagement.\n",
            },
        ],
        attachments: [],
        links: [],
    ...
    },
    {
        ...
        summaryShort: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
...
export const CASE_STUDIES_FIXTURE_FULL = CASE_STUDIES_FIXTURE_FULL_RAW.map((x) => CaseStudySchema.parse(x));
...
const FULL_FROM_SEEDS = SEEDS.map((s) => normalize(s));
/**

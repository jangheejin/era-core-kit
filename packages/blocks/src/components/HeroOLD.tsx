        ...
        <div className="hero-grid">
          ...
          <div className="hero-copy">
            ...
            <p className="type-body">
              ...
              consulting and public affairs firm. We solve problems, enhance
              your brand, offer strategic advice and leverage robust
              relationships to advance your interests in Washington D.C.
            </p>
            <p className="type-body">
              With years of experience working both in Congress and as
              government affairs professionals, we have a proud track record of
              getting legislation signed into law by working across the aisle

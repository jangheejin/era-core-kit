      ...
      <div className="c-container c-grid" style={{ alignItems: "center" }}>
        <div>
          ...
          <p className="type-body">
            Our mission is to develop and maintain a close relationship our
            clients, which means understanding their mission needs and
            objectives, and to jointly develop a targeted and pragmatic strategy
            to achieve them.
          </p>
        </div>
        <div>
